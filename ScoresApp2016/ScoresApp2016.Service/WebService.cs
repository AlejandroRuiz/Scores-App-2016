...
using ScoresApp2016.Service.Responses;
using System.Collections.Generic;
using System.Linq;
using ScoresApp2016.Defaults;
					...
					if (requestDetailInfo)
					{
						foreach (var match in fixtures.fixtures)
						{
							...
							if (resulthomeTeam.StatusCode == HttpStatusCode.OK)
							{
								...
								var team = JsonConvert.DeserializeObject<Service.Responses.Team.Team>(responhomeTeamText);
							...
							if (resultawayTeam.StatusCode == HttpStatusCode.OK)
							{
								...
								var team = JsonConvert.DeserializeObject<Service.Responses.Team.Team>(responawayTeamText);
				...
				if (fixtureResult.StatusCode == HttpStatusCode.OK)
				{
					...
					if (requestDetailInfo)
					{
						...
						if (resulthomeTeam.StatusCode == HttpStatusCode.OK)
						{
							...
							var team = JsonConvert.DeserializeObject<Service.Responses.Team.Team>(respondhomeTeam);
							...
							if (resulthomeTeamPlayers.StatusCode == HttpStatusCode.OK)
							{
								...
								var players = JsonConvert.DeserializeObject<Service.Responses.Players>(respondhomeTeamPlayers);
						...
						if (resultawayTeam.StatusCode == HttpStatusCode.OK)
						{
							...
							var team = JsonConvert.DeserializeObject<Service.Responses.Team.Team>(respondawayTeam);
							...
							if (resultawayTeamPlayers.StatusCode == HttpStatusCode.OK)
							{
								...
								var players = JsonConvert.DeserializeObject<Service.Responses.Players>(respondawayTeamPlayers);
